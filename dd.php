...
echo "| PENGEMBANGAN SCRIPT,, Thx To Arie, Dan R3 \n";
//echo "| --------------------------- \n";
if(file_exists("config.json")){
    ...
    $memberid = $arr2['id'];
    $hp = $arr2['hp'];
    echo "| Lo udah login pake nomer hp $hp \n";
    echo "| 1. LOGIN (Error) \n";
    echo "| 2. DAFTAR \n";
    echo "| PILIHIN 2: ";
...
$data_create = '{"address":"","birthDate":"1988-10-11","debug":false,"deviceId":'.$deviceid2.',"email":'.$random_email.',"firstName":"","fullName":'.$random_name.',"gender":"F","lastName":"","latitude":0,"longitude":0,"maritalStatus":"M","password":'.$password.',"phone":'.$nomorhp.',"postCode":"","registerPonta":true,"token":'.$token2.'}';
...
if($status_create !== "00"){
    ...
    echo "| SUKSEEEEESSSSED DAFTAR !! \n";
    echo "| NOMER HP $no_hp DAN PASSWORD $password \n";
    echo "| ID Ponta $id_ponta \n";
    echo "| SABAR YAA \n";
    sleep(4);
